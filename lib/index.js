      ...
      res.write = function (chunk, encoding) {
          ...
          if (res.statusCode === 200) {
            ...
            if (tags.length === 0) {
              ...
              Esi.prototype._processEsi(req.headers, strchunk, tags)
                .then(
                  function(result) {
    ...
    return Q.Promise(function (resolve, reject) {
      ...
      for (var tag in tags) {
        if (tags.hasOwnProperty(tag)) {
          ...
          currentPromise.then(function(data) {
            ...
            log.debug(data.status, data.body);

            var body = reader.read(data.body, encoding);

            log.debug('adding', src, body);
      ...
      allPromises.then(
        function() {
          ...
          // log.debug('sub data', substitutedData);
